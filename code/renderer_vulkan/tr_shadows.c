...
static void vk_renderShadowEdges(pipelineDef vk_pipeline)
{
	...
	while (i < numExtrudedEdges) {
		...
		vk_shade_geometry(vk_pipeline, VK_FALSE, DEPTH_RANGE_NORMAL, VK_TRUE, backEnd.viewParms.isPortal);
...
void RB_ShadowFinish( void )
{
	...
	vk_shade_geometry(g_stdPipelines.shadow_finish_pipeline, VK_FALSE, DEPTH_RANGE_NORMAL, VK_TRUE, backEnd.viewParms.isPortal);
