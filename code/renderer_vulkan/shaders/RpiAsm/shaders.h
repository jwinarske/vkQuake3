...
"sig_color_load ; tlb_stencil_setup.nop = or.always.nop(a, a, uni, nop) ; nop = nop.never(r0, r0) ; "
"sig_load_imm ; r3 = load32.always(0x18) ; nop = load32() ;"
"sig_none ; r2.nop = shr.always.nop(r4, r3, nop, pay_zw) ; tlb_z = v8min.always(b, b) ; "
...
"sig_load_imm ; r1 = load32.always(0x10) ; nop = load32() ;"
"sig_none ; r0.nop = shl.always.nop(r3, r1) ; nop = nop.never(r0, r0) ; "
...
char singleTextureClippingPlane_AlphaDisabled_DstOneMinusDstAlpha_SrcDstColor_DepthStencilEnabled_FS[] =
{
	...
	"sig_color_load ; tlb_stencil_setup.nop = or.always.nop(a, a, uni, nop) ; nop = nop.never(r0, r0) ; "
	"sig_load_imm ; r3 = load32.always(0x18) ; nop = load32() ;"
	"sig_none ; r2.nop = shr.always.nop(r4, r3, nop, pay_zw) ; tlb_z = v8min.zs(b, b) ; "
	...
	"sig_load_imm ; r2 = load32.always(0x10) ; nop = load32() ;"
	"sig_none ; r2.nop = shl.always.nop(r3, r2, nop, nop) ; nop = nop.never(r0, r0) ; "
...
char singleTexture_AlphaGE80_BlendDisabled_DepthStencilEnabled_FS[] =
{
	...
	"sig_small_imm ; nop.nop = fsub.always.sf.nop(r0, b, nop, 0x3f000000) ; nop = nop.never(r0, r0) ; "
	"sig_small_imm ; r2.nop = or.ns.nop(b, b, nop, -1) ; nop = nop.never(r0, r0) ; "
...
char singleTextureClippingPlane_AlphaGE80_BlendDisabled_DepthStencilEnabled_FS[] =
{
	...
	"sig_small_imm ; r2.nop = or.always.nop(b, b, nop, 0) ; nop = nop.never(r0, r0) ; "
	"sig_small_imm ; nop.nop = fsub.always.sf.nop(r1, b, nop, 0x3f000000) ; nop = nop.never(r0, r0) ; "
	"sig_none ; r2 = or.pm.always.nop(a, a, ra0, rb2) ; rx0.8a = fmul.always(b, r3) ; "
	"sig_small_imm ; r0.nop = or.ns.nop(b, b, nop, -1) ; nop = nop.never(r0, r0) ; "
...
char singleTexture_AlphaGE80_DstOneMinusSrcAlpha_SrcSrcAlpha_DepthStencilEnabled_FS[] =
{
	"sig_none ; nop.nop = nop.never.nop(r0, r0, pay_zw, vary) ; r0 = fmul.always(b, a) ; "
	"sig_none ; rx0.nop = fadd.ws.always.nop(r0, r5, pay_zw, vary) ; r1 = fmul.always(b, a) ; "
	"sig_none ; rx1.nop = fadd.always.nop(r1, r5, pay_zw, vary) ; r2 = fmul.always(b, a) ; "
	...
	"sig_none ; r1 = fmax.pm.always.8c(r4, r4, ra1, nop) ; r2.8b = fmul.always(a, r0) ; "
	"sig_none ; nop = nop.pm.never.nop(r0, r0, nop, rb1) ; r2.8a = fmul.always(b, r1) ; "
	"sig_none ; nop = nop.pm.never.8d(r0, r0, ra0, nop) ; r1.nop = fmul.always(a, r4) ; "
	"sig_small_imm ; r3.nop = or.always.nop(b, b, nop, 0) ; nop = nop.never(r0, r0) ; "
	"sig_small_imm ; nop.nop = fsub.always.sf.nop(r1, b, nop, 0x3f000000) ; nop = nop.never(r0, r0) ; "
	"sig_small_imm ; r3.nop = or.ns.nop(b, b, nop, -1) ; nop = nop.never(r0, r0) ; "
	"sig_none ; nop = nop.pm.never.nop(r0, r0, nop, nop) ; r2.8d = v8min.always(r1, r1) ; "
	"sig_none ; nop = nop.pm.never.nop(r0, r0, nop, nop) ; r0.8888 = v8min.always(r1, r1) ; "
	"sig_none ; nop.nop = or.always.sf.nop(r3, r3, nop, nop) ; nop = nop.never(r0, r0) ; "
	"sig_none ; r1.nop = not.always.nop(r0, r0, nop, nop) ; r3 = v8muld.always(r2, r0) ; "
	"sig_color_load ; tlb_stencil_setup.nop = or.always.nop(a, a, uni, nop) ; nop = nop.never(r0, r0) ; "
	"sig_none ; tlb_z.nop = or.zs.nop(b, b, nop, pay_zw) ; r2 = v8muld.always(r4, r1) ; "
	"sig_none ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; r0 = v8adds.always(r3, r2) ; "
	"sig_none ; tlb_color_all.nop = or.zs.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
	"sig_end ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
	"sig_none ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
	"sig_unlock_score ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
...
char singleTextureClippingPlane_AlphaGE80_DstOneMinusSrcAlpha_SrcSrcAlpha_DepthStencilEnabled_FS[] =
{
	"sig_none ; nop.nop = nop.never.nop(r0, r0, pay_zw, vary) ; r0 = fmul.always(b, a) ; "
	"sig_none ; rx1.nop = fadd.ws.always.nop(r0, r5, pay_zw, vary) ; r1 = fmul.always(b, a) ; "
	"sig_none ; rx2.nop = fadd.always.nop(r1, r5, pay_zw, vary) ; r2 = fmul.always(b, a) ; "
	...
	"sig_none ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
	"sig_small_imm ; r0.nop = or.always.nop(b, b, nop, 0) ; nop = nop.never(r0, r0) ; "
	"sig_load_tmu0 ; r0.nop = or.always.nop(a, a, ra0, nop) ; nop = nop.never(r0, r0) ; "
	"sig_none ; r1 = fmax.pm.always.8a(r4, r4, nop, nop) ; nop.nop = nop.never(r0, r0) ; "
	"sig_none ; r2 = fmax.pm.always.8b(r4, r4, nop, rb1) ; rx0.8c = fmul.always(b, r1) ; "
	"sig_none ; r3 = fmax.pm.always.8c(r4, r4, ra2, nop) ; rx0.8b = fmul.always(a, r2) ; "
	"sig_none ; nop = nop.pm.never.nop(r0, r0, nop, rb2) ; rx0.8a = fmul.always(b, r3) ; "
	"sig_none ; nop = nop.pm.never.8d(r0, r0, ra1, nop) ; r2.nop = fmul.always(a, r4) ; "
	"sig_small_imm ; r1.nop = or.always.nop(b, b, nop, 0) ; nop = nop.never(r0, r0) ; "
	"sig_small_imm ; nop.nop = fsub.always.sf.nop(r2, b, nop, 0x3f000000) ; nop = nop.never(r0, r0) ; "
	"sig_none ; nop = nop.pm.never.nop(r0, r0, nop, nop) ; rx0.8d = v8min.always(r2, r2) ; "
	"sig_small_imm ; r1.nop = or.ns.nop(b, b, nop, -1) ; nop = nop.never(r0, r0) ; "
	"sig_none ; r0 = or.pm.always.nop(a, r1, ra0, nop) ; r2.8888 = v8min.always(r2, r2) ; "
	"sig_none ; r3.nop = not.always.nop(r2, r2, nop, rb0) ; r1 = v8muld.always(b, r2) ; "
	"sig_none ; nop.nop = or.always.sf.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
	"sig_color_load ; tlb_stencil_setup.nop = or.always.nop(a, a, uni, nop) ; nop = nop.never(r0, r0) ; "
	"sig_none ; tlb_z.nop = or.zs.nop(b, b, nop, pay_zw) ; r0 = v8muld.always(r4, r3) ; "
	"sig_none ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; r2 = v8adds.always(r1, r0) ; "
	"sig_none ; tlb_color_all.nop = or.zs.nop(r2, r2, nop, nop) ; nop = nop.never(r0, r0) ; "
...
char multiTextureAdd_AlphaDisabled_DstOne_SrcOne_DepthStencilEnabled_FS[] =
{
"sig_none ; nop.nop = nop.never.nop(r0, r0, pay_zw, vary) ; r0 = fmul.always(b, a) ; "
"sig_none ; rx4.nop = fadd.ws.always.nop(r0, r5, pay_zw, vary) ; r1 = fmul.always(b, a) ; "
"sig_none ; rx4.nop = fadd.always.nop(r1, r5, pay_zw, vary) ; r2 = fmul.always(b, a) ; "
...
"sig_color_load ; tlb_stencil_setup.nop = or.always.nop(a, a, uni, nop) ; nop = nop.never(r0, r0) ; "
"sig_none ; tlb_z.nop = or.always.nop(b, b, nop, pay_zw) ; nop = nop.never(r0, r0) ; "
"sig_none ; nop.nop = nop.ws.never.nop(r0, r0, nop, nop) ; tlb_color_all = v8adds.always(r1, r4) ; "
"sig_end ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
"sig_none ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
"sig_unlock_score ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
};

char multiTextureAddClippingPlane_AlphaDisabled_DstOne_SrcOne_DepthStencilEnabled_FS[]=
{
"sig_none ; nop.nop = nop.never.nop(r0, r0, pay_zw, vary) ; r0 = fmul.always(b, a) ; "
"sig_none ; rx5.nop = fadd.always.nop(r0, r5, pay_zw, vary) ; r1 = fmul.always(b, a) ; "
"sig_none ; rx4.nop = fadd.ws.always.nop(r1, r5, pay_zw, vary) ; r2 = fmul.always(b, a) ; "
"sig_none ; rx3.nop = fadd.ws.always.nop(r2, r5, pay_zw, vary) ; r3 = fmul.always(b, a) ; "
"sig_none ; rx4.nop = fadd.always.nop(r3, r5, pay_zw, vary) ; r0 = fmul.always(b, a) ; "
"sig_none ; r0.nop = fadd.always.nop(r0, r5, pay_zw, vary) ; r1 = fmul.always(b, a) ; "
"sig_none ; r2.nop = fadd.always.nop(r1, r5, pay_zw, vary) ; r3 = fmul.always(b, a) ; "
"sig_none ; rx2.nop = fadd.ws.always.nop(r3, r5, nop, nop) ; tmu0_t = v8min.always(r2, r2) ; "
"sig_none ; tmu0_s.nop = or.always.nop(r0, r0, pay_zw, vary) ; r0 = fmul.always(b, a) ; "
"sig_none ; rx0.nop = fadd.always.nop(r0, r5, pay_zw, vary) ; r1 = fmul.always(b, a) ; "
"sig_small_imm ; rx3.nop = or.always.nop(b, b, nop, 0) ; nop = nop.never(r0, r0) ; "
"sig_thread_switch ; r2.nop = fadd.always.nop(r1, r5, nop, nop) ; nop = nop.never(r0, r0) ; "
...
"sig_small_imm ; rx3.nop = or.ns.nop(b, b, nop, -1) ; nop = nop.never(r0, r0) ; "
"sig_none ; tmu0_t.nop = or.ws.always.nop(a, a, ra0, nop) ; nop = nop.never(r0, r0) ; "
"sig_none ; tmu0_s.nop = or.ws.always.nop(b, b, nop, rb2) ; nop = nop.never(r0, r0) ; "
"sig_load_tmu0 ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
"sig_none ; nop = nop.pm.never.8c(r0, r0, nop, rb3) ; rx1.nop = fmul.always(b, r4) ; "
"sig_last_thread_switch ; nop = nop.ws.pm.never.8b(r0, r0, nop, rb4) ; rx1.nop = fmul.always(b, r4) ; "
"sig_none ; nop = nop.pm.never.8a(r0, r0, ra5, nop) ; rx0.nop = fmul.always(a, r4) ; "
"sig_none ; nop = nop.ws.pm.never.8d(r0, r0, ra4, nop) ; rx2.nop = fmul.always(a, r4) ; "
"sig_none ; nop.nop = or.always.sf.nop(a, a, ra3, nop) ; nop = nop.never(r0, r0) ; "
"sig_load_tmu0 ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
"sig_none ; r3 = fmax.pm.always.8d(r4, r4, nop, nop) ; nop.nop = nop.never(r0, r0) ; "
"sig_none ; r1 = fadd.pm.always.8c(b, r4, ra2, rb1) ; r3.8d = fmul.always(a, r3) ; "
"sig_none ; r0 = fadd.pm.always.8b(a, r4, ra1, nop) ; r3.8a = v8min.always(r1, r1) ; "
"sig_none ; r2 = fadd.pm.always.8a(b, r4, nop, rb0) ; r3.8b = v8min.always(r0, r0) ; "
"sig_none ; nop = nop.pm.never.nop(r0, r0, nop, nop) ; r3.8c = v8min.always(r2, r2) ; "
"sig_color_load ; tlb_stencil_setup.nop = or.always.nop(a, a, uni, nop) ; nop = nop.never(r0, r0) ; "
"sig_none ; tlb_z.nop = or.zs.nop(b, b, nop, pay_zw) ; r1 = v8adds.always(r3, r4) ; "
"sig_none ; tlb_color_all.nop = or.zs.nop(r1, r1, nop, nop) ; nop = nop.never(r0, r0) ; "
"sig_end ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
"sig_none ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
"sig_unlock_score ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
...
char singleTexture_AlphaDisabled_DstSrcColor_SrcZero_DepthStencilEnabled_FS[]=
{
"sig_none ; nop.nop = nop.never.nop(r0, r0, pay_zw, vary) ; r0 = fmul.always(b, a) ; "
"sig_none ; rx0.nop = fadd.always.nop(r0, r5, pay_zw, vary) ; r1 = fmul.always(b, a) ; "
"sig_none ; rx0.nop = fadd.ws.always.nop(r1, r5, pay_zw, vary) ; r2 = fmul.always(b, a) ; "
...
"sig_color_load ; tlb_stencil_setup.nop = or.always.nop(a, a, uni, nop) ; nop = nop.never(r0, r0) ; "
"sig_none ; tlb_z.nop = or.always.nop(b, b, nop, pay_zw) ; nop = nop.never(r0, r0) ; "
"sig_none ; nop.nop = nop.ws.never.nop(r0, r0, nop, nop) ; tlb_color_all = v8muld.always(r4, r3) ; "
"sig_end ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
"sig_none ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
"sig_unlock_score ; nop.nop = nop.never.nop(r0, r0, nop, nop) ; nop = nop.never(r0, r0) ; "
};

char singleTextureClippingPlane_AlphaDisabled_DstSrcColor_SrcZero_DepthStencilEnabled_FS[]=
{
"sig_none ; nop.nop = nop.never.nop(r0, r0, pay_zw, vary) ; r0 = fmul.always(b, a) ; "
"sig_none ; rx0.nop = fadd.ws.always.nop(r0, r5, pay_zw, vary) ; r1 = fmul.always(b, a) ; "
"sig_none ; rx1.nop = fadd.always.nop(r1, r5, pay_zw, vary) ; r2 = fmul.always(b, a) ; "
